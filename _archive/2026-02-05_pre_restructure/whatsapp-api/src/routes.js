...
routes.get('/leads/webhook', leadsController.facebookWebhookVerification)
routes.post('/leads/webhook', leadsController.facebookWebhook)

// Leads Management (Protected)
const leadsRouter = express.Router()
leadsRouter.use(middleware.apikey)
routes.use('/leads', leadsRouter)
leadsRouter.get('/', leadsController.getLeads)
leadsRouter.post('/', leadsController.addLead)
leadsRouter.put('/:id', leadsController.updateLead)
leadsRouter.delete('/:id', leadsController.deleteLead)
const configController = require('./controllers/configController')
routes.get('/settings', [middleware.apikey], configController.getSettings)
routes.post('/settings', [middleware.apikey], configController.updateSettings)
